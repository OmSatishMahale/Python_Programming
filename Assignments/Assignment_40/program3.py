...
def main():
    ...
    print("Accuracy with every Column : ", accuracy_before * 100)

    model_after = DecisionTreeClassifier(random_state=42)

    X_after = df[["StudyHours","Attendance"]]
    ...
    print("Accuracy of Model with only StudyHours and Attendance:", accuracy_after * 100)
